...
*/ 
    ...
    'PORTIONING'=>' AND order_status = 1 and (pay_status=1 OR pay_code="cod") AND shipping_status !=1',
    ...
    //短信使用场景
    'SEND_SCENE' => array(
        '1'=>array('用户注册','验证码：${code}（请勿泄露），此校验码30分钟内有效。','regis_sms_enable'),
        ...
        '6'=>array('身份验证','验证码：${code}（请勿泄露），此校验码30分钟内有效。','bind_mobile_sms_enable'),
    ),
    ...
    /**假设这个访问地址是 www.icngo.cn/home/goods/goodsInfo/id/1.html
