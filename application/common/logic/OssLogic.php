...
class OssLogic
{
    ...
    static private $accessKeyId = 'LTAI6AjqBZxsLz0z';
    static private $accessKeySecret = 'TlrEqyrLsHLW2rYkLJ4QjrhFAqhXuL ';
    static private $endpoint = 'http://oss-cn-hangzhou.aliyuncs.com';
    static private $bucket = 'http://yuxuanmall.oss-cn-hangzhou.aliyuncs.com';
