...
class Wechat extends Base
{
    ...
    public function pub_menu(){
        ...
        if(!$access_token){
            $this->error('获取access_token失败',U('Wechat/menu')); //  http://www.icngo.cn/index.php/Admin/Wechat/menu
...
//        exit($post_str);
    ...
    public function select_goods(){
        ...
        //http://www.icngo.cn/index.php?m=Home&c=Goods&a=info&id=
