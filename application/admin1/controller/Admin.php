...
class Admin extends Base {
    ...
    public function login(){
        ...
        if(IS_POST){
            //前三次不出现我验证码
            if(!isset($_SESSION['verifyCodeNum'])){
                $_SESSION['verifyCodeNum']=1;
            }else{
                $_SESSION['verifyCodeNum']=$_SESSION['verifyCodeNum']+1;
            }
            if($_SESSION['verifyCodeNum']>2) {
                $verify = new Verify();
